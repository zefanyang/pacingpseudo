...
class LVSCDataset(Dataset):
    ...
    def __init__(self,
                 ...
                 num_classes,
                 dtype=np.float32):
        super(LVSCDataset, self).__init__()
...
class LVSCTwoStream(LVSCDataset):
    def __init__(self,
                 file_ls,
                 num_classes,
                 ...
                 do_strong=False,):
        super(LVSCTwoStream, self).__init__(file_ls, num_classes)
    ...
    def __getitem__(self, item):
        ...
        names_to_data = super(LVSCTwoStream, self).__getitem__(item)
